export default {
  ...
  stats: {
    ...
    invitesblock_desc:
      'Control and block invites, which should be published on guild.',
  ...
  appeal: {
    ...
    main_description:
      'Submit a request to appeal a blacklisting or warning in the AntiLink bot database. We will review your request as soon as possible.',
    form: {
  ...
  guild: {
    ...
    backups: {
      title: 'Backups',
      no_perms:
        'To work with backups, bot needs <strong>Administrator</strong> rights.',
  ...
  backups: {
    ...
    page_title: 'Backups',
    page_description:
      'Manage your server backups. Create, restore, and monitor backup status.',
  ...
  docs: {
    ...
    main_description:
      'A powerful bot to protect your Discord server from unwanted guests and spam.',
    note_automatic_protection:
      'AntiLink automatically protects your server using an advanced moderation system and user database.',
    ...
    feature_warning_system_desc:
      'maintaining a database with punishment reasons',
    ...
    feature_cross_server_desc:
      'blocking on all servers with activated protection',
    feature_crash_bots: 'Crash bot protection',
    feature_crash_bots_desc:
      'automatic detection and blocking of hacking attempts',

    work_concept_title: 'Working concept',
    concept_step1: 'The bot monitors all messages where it has access',
    concept_step2:
      "When an invitation is detected, and if the member doesn't have a whitelisted role - the bot deletes the invitation and issues 1 warning",
    concept_step3_highlight: 'Third warning:',
    concept_step3_text: '- addition to blacklist and blocking',
    concept_step4:
      'If a user joins the guild, writes a message, and after verification the bot detects 3 warnings - they are blocked.',

    warning_blacklist:
      'Users from the blacklist will be automatically blocked on all servers where AntiLink is added with activated protection settings.',
    warning_default_settings:
      'By default, all bot settings are disabled. You need to configure the bot for it to work on your guild.',

    whitelist_title: 'Role whitelist',
    whitelist_note:
      'Roles added to the whitelist bypass all AntiLink checks. Users with these roles do not receive warnings.',
    whitelist_add: 'Add role to whitelist',
    whitelist_remove: 'Remove role from whitelist',
    role: 'role',
    whitelist_warning:
      'Be careful when adding roles to the whitelist. Users with these roles will be able to bypass all bot restrictions.',
    whitelist_permissions:
      'Whitelist settings are only available to server administrators with appropriate permissions.',
    ...
    note_owner_only:
      'Only the guild owner can change bot settings. This prevents unauthorized interference with the security system.',

    user_database_title: 'User database',
    user_database_desc:
      'AntiLink stores detailed information about each violation:',
  ...
  privacy: {
    ...
    intro_text:
      'This topic describes the terms of use and privacy policy of the AntiLink bot. By using the bot, you automatically agree to these terms.',
    priority_text:
      'For our team, privacy and security are the highest priorities. Below is information about the data collected and stored in the AntiLink bot database.',

    data_collection_title: 'Data Collection and Processing',
    data_collection_desc:
      "AntiLink stores the following technical data necessary for the bot's operation:",
    data_discord_id: 'User Discord ID',
    data_discord_id_desc:
      '- technical identifier of the Discord account (does not contain personal information)',
    data_server_id: 'Server IDs',
    data_server_id_desc:
      '- identifiers of Discord servers where the bot is used',
    ...
    data_evidence_desc:
      '- screenshots (stored only in cases of rule violations)',

    important_note:
      'Important: The bot <strong>does not collect</strong> or store such personal data as:',
  ...
  tos: {
    ...
    intro_text:
      'This topic contains the Terms of Service for the Discord bot AntiLink.',

    general_provisions_title: 'General Provisions',
    general_provisions_desc:
      'First of all, by using the AntiLink bot, you automatically agree to:',
    ...
    disagreement_warning:
      'If you do not agree to the Terms of Service or Privacy Policy - you are prohibited from using our program.',
    ...
    prohibited_2_desc:
      'to use the AntiLink bot with the purpose of harming other Discord users',
    prohibited_3_title: 'Prohibited',
    prohibited_3_desc:
      'to intentionally use bot vulnerabilities, bugs for the purpose of obtaining unfair advantage',
    changes_note:
      'We may make changes to the Terms of Service for certain reasons, notifying about it on the official Discord technical support server.',

    blacklist_title: 'Blacklist',
    blacklist_desc:
      'A user may be added to the blacklist for the following reasons:',
    blacklist_reason_1: 'Violation of Discord rules',
    blacklist_reason_2: 'Server raids',
    blacklist_reason_3: 'Crash-bot',
    blacklist_reason_4:
      'Distribution, advertising, development, dissemination, etc. of prohibited software for harming Discord users or guilds',
    ...
    blacklist_reason_6_desc:
      '(those who furiously use anti-Ukrainian statements, insults to the Ukrainian nation, etc.)',

    access_restrictions_title: 'Access Restrictions',
    access_restrictions_desc:
      'We have the right to restrict your use of our program due to:',
    restriction_reason_1: 'Violation of Discord rules',
    restriction_reason_2:
      'Violation of our AntiLink Terms of Service or privacy policy',
