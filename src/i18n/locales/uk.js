export default {
  ...
  stats: {
    ...
    invitesblock_desc:
      'Контроль над запрошеннями, які можуть бути опубліковані на сервері',
  ...
  appeal: {
    ...
    main_description:
      'Подайте заявку на оскарження чорного списку або попередження в базі даних бота AntiLink. Ми розглянемо ваш запит якомога швидше.',
    form: {
      title_discord_id: 'Ваш Discord ID',
      punish_date: 'Приблизна дата отримання покарання',
      reason: 'Причина покарання',
      reason_desc:
        'Опишіть детально причину, через яку ви отримали покарання...',
  ...
  guild: {
    ...
    backups: {
      ...
      no_perms:
        'Для роботи з резервними копіями боту потрібні права <strong>Адміністратора</strong>',
      ...
      restore: 'Відновити',
      cooldown:
        'Повторне відновлення буде доступне через {{ cooldownTime }} секунд',
      delete: 'Видалити',
      creating: 'Створення...',
  ...
  backups: {
    ...
    page_description:
      'Керуйте резервними копіями ваших серверів. Створюйте, відновлюйте та моніторьте стан бекапів.',
    ...
    empty_state_description:
      'Створіть свою першу резервну копію, щоб захистити дані ваших серверів',
  ...
  docs: {
    ...
    main_description:
      'Потужний бот для захисту вашого Discord сервера від небажаних гостей та спаму.',
    note_automatic_protection:
      'AntiLink автоматично захищає ваш сервер, використовуючи розширену систему модерації та базу даних користувачів.',
    ...
    feature_blacklist_desc:
      'користувачі з 3+ попередженнями автоматично блокуються',
    feature_cross_server: 'Крос-серверна база',
    feature_cross_server_desc:
      'блокування на всіх серверах з активованим захистом',
    ...
    concept_step2:
      'При виявленні запрошення, і якщо в учасника немає ролі з білого списку - бот видаляє запрошення, та видає 1 попередження',
    concept_step3_highlight: 'Третє попередження:',
    concept_step3_text: '- додавання до чорного списку та блокування',
    concept_step4:
      'За умови, якщо в гільдію зайшов користувач, написав повідомлення, і після перевірки бот виявив 3 попередження - його блокує.',

    warning_blacklist:
      'Користувачі з чорного списку автоматично блокуватимуться на всіх серверах, де доданий AntiLink з активованими налаштуваннями захисту.',
    warning_default_settings:
      'За замовчуванням всі налаштування бота вимкнені. Вам потрібно налаштувати бота, щоб він працював на вашій гільдії.',

    whitelist_title: 'Білий список ролей',
    whitelist_note:
      'Ролі, додані до білого списку, обходять усі перевірки AntiLink. Користувачі з цими ролями не отримують попереджень.',
    whitelist_add: 'Додати роль до білого списку',
    whitelist_remove: 'Видалити роль з білого списку',
    role: 'роль',
    whitelist_warning:
      'Будьте обережні при додаванні ролей до білого списку. Користувачі з цими ролями зможуть уникати всіх обмежень бота.',
    whitelist_permissions:
      'Налаштування білого списку доступні лише адміністраторам сервера з відповідними правами.',
    ...
    note_owner_only:
      'Лише власник гільдії може змінювати налаштування бота. Це запобігає несанкціонованому втручанню у систему безпеки.',

    user_database_title: 'База даних користувачів',
    user_database_desc:
      'AntiLink зберігає детальну інформацію про кожне порушення:',
  ...
  privacy: {
    ...
    intro_text:
      'В даній темі описані умови використання та політика конфіденційності бота AntiLink. Використовуючи бота, ви автоматично погоджуєтесь з цими умовами.',
    priority_text:
      'Для нашої команди конфіденційність та безпека є найважливішими пріоритетами. Нижче наведена інформація про дані, які збираються та зберігаються в базі даних бота AntiLink.',

    data_collection_title: 'Збір та обробка даних',
    data_collection_desc:
      'AntiLink зберігає такі технічні дані, необхідні для роботи бота:',
    data_discord_id: 'Discord ID користувача',
    data_discord_id_desc:
      '- технічний ідентифікатор облікового запису Discord (не містить особистої інформації)',
    data_server_id: 'ID серверів',
    data_server_id_desc:
      '- ідентифікатори Discord-серверів, де використовується бот',
    data_role_id: 'ID ролей',
    data_role_id_desc:
      '- ідентифікатори ролей серверу, доданих до білого списку',
    data_evidence: 'Докази порушень',
    data_evidence_desc:
      '- скріншоти (зберігаються лише у випадках порушень правил)',

    important_note:
      'Важливо: Бот <strong>не збирає</strong> та не зберігає такі персональні дані як:',
  ...
  tos: {
    ...
    intro_text:
      'В даній темі написані Умови користування Discord ботом AntiLink.',

    general_provisions_title: 'Загальні положення',
    general_provisions_desc:
      'Перш за все, користуючись ботом AntiLink, ви автоматично погоджуєтесь з:',
    ...
    disagreement_warning:
      'Якщо ви не погоджуєтесь з Умовами користування або Політикою конфіденційності - вам заборонено використовувати нашу програму.',

    prohibited_actions_title: 'Заборонені дії',
    penalties_text:
      'За порушення цих правил Ви можете отримати покарання у вигляді:',
    ...
    prohibited_2_desc:
      'використовувати бота AntiLink з метою шкоди іншим користувачам Discord',
    prohibited_3_title: 'Заборонено',
    prohibited_3_desc:
      'навмисно використовувати недоліки бота, баги з метою отримання неправомірної вигоди',
    changes_note:
      'Ми можемо вносити зміни до Умов Користування з певних причин, повідомивши про це на офіційному Discord сервері технічної підтримки.',

    blacklist_title: 'Чорний список',
    blacklist_desc:
      'Користувач може бути занесений до чорного списку з наступних причин:',
    blacklist_reason_1: 'Порушення правил Discord',
    blacklist_reason_2: 'Рейд серверів',
    blacklist_reason_3: 'Краш-бот',
    blacklist_reason_4:
      'Поширення, реклама, розробка, розповсюдження і т.д забороненого ПО для нанесення шкоди користувачам або гільдіям Discord',
    blacklist_reason_5: 'Реклама в особисті повідомлення/на серверах',
    blacklist_reason_6_title: 'Запекла русня',
    blacklist_reason_6_desc:
      '(ті, які люто використовують антиукраїнські висловлювання, образи української нації, і т.д)',

    access_restrictions_title: 'Обмеження доступу',
    access_restrictions_desc:
      "Ми маємо право обмежити вам користування нашою програмою у зв'язку з:",
    restriction_reason_1: 'Порушенням правил Discord',
    restriction_reason_2:
      'Порушенням наших Умов користування AntiLink або політики конфіденційності',
    restriction_reason_3: 'Виконанням вимог Discord',
    restriction_reason_4:
      'Підставами вважати, що ви наносите шкоду нашій програмі',
  },
