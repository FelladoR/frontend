<template>
  ...
  <link rel="stylesheet" href="/src/styles/guild.css" />
      ...
      <div v-else class="guild-settings">
        ...
        <div class="tab-content" :class="{ active: activeTab === 'main' }">
          <div class="settings-card">
            <h4 class="mb-4">
              <i class="fa-solid fa-gear" />{{ t('guild.main_settings.title') }}
            </h4>
          ...
          <div class="settings-card">
            ...
            <div class="mb-3">
              ...
              <div v-if="currentWebhook" class="mb-2 p-3 bg-dark rounded">
                ...
                <div>
                  <strong>{{ t('guild.logging.webhook_data.channel') }}</strong>
            ...
            <div v-if="loggingSettings.webhookId" class="mb-3">
              ...
              <div class="input-group">
                ...
                >
                  <i
                    :class="showWebhookUrl ? 'fas fa-eye-slash' : 'fas fa-eye'"
                  />
                </button>
              </div>
            </div>
              ...
              <div class="mb-3">
                ...
                >
                  ...
                  <option
                    ...
                    :value="role.id"
                    :selected="role.id === verificationSettings.unverifiedRole"
                  >
                    {{ role.name }}
                  </option>
                </select>
          ...
          <div class="settings-card">
            ...
            <div class="backups-section mt-4">
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td>
                        ...
                        >
                          <template
                            v-if="restoringId === (backup._id || backup.id)"
                          >
                        ...
                        <div
                          v-if="cooldownId === (backup._id || backup.id)"
                          class="text-muted small mt-1"
                        >
                          <span v-html="t('guild.backups.cooldown')" />
                        </div>

                        <button
                          class="btn btn-sm btn-danger"
                          title="{{ t('guild.backups.delete')}}"
                          :disabled="!hasAdminPermissions"
                          @click="confirmDeleteBackup(backup._id || backup.id)"
                        >
              ...
              >
                <button
                  class="btn btn-primary"
                  :disabled="backups.creating || !hasAdminPermissions"
...
async function confirmRestoreBackup(id) {
  if (confirm('Ви впевнені, що хочете відновити цей бекап?')) {
